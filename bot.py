...
class GlobalView(discord.ui.View):
    ...
    async def bouton_total_gorgon(self, interaction: discord.Interaction, button: discord.ui.Button):
        try:
            ...
            await interaction.response.send_message("❌ Erreur lors de la récupération des données globales.", ephemeral=True)
    ...
    async def bouton_stats(self, interaction: discord.Interaction, button: discord.ui.Button):
        try:
            ...
            await interaction.response.send_message("❌ Erreur lors de la récupération des statistiques globales.", ephemeral=True)
